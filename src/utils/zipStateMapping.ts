...
// Maps ZIP code prefixes to state abbreviations
...
/**
 * Gets the state abbreviation for a given ZIP code
...
/**
 * Gets states for multiple ZIP codes
 * @param zipCodes - Array of 5-digit ZIP codes
 * @returns Array of objects with zip and state
 */
export function getStatesFromZips(zipCodes: string[]): Array<{ zip: string; state: string | null }> {
