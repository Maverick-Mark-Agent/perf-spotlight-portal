...
import { Save, X, Plus, Info, Loader2 } from 'lucide-react';
...
interface ReplyTemplatesTabProps {
  workspaceName: string;
  clientDisplayName: string;
}

export function ReplyTemplatesTab({ workspaceName, clientDisplayName }: ReplyTemplatesTabProps) {
  ...
  const fetchTemplate = async () => {
    try {
      ...
      if (data) {
        ...
        setTemplateNoPhone('');
        setCcEmails([]);
        setSpecialInstructions('Template not yet configured - please customize');
      }
    } catch (error) {
  ...
  const handleSave = async () => {
    try {
      ...
      toast({
        ...
        description: 'Reply template updated successfully',
      });
  ...
  return (
    <div className="space-y-4">
        ...
        <CardContent className="pt-6">
          <div className="flex gap-2">
            ...
            <div className="space-y-1">
              <p className="text-sm text-blue-900 font-medium">AI Reply System</p>
              <p className="text-sm text-blue-700">
                These templates are used by Claude AI to generate personalized replies to interested leads.
      ...
      <Card>
        <CardHeader>
          <CardTitle>Template with Phone Number</CardTitle>
          <CardDescription>
            Used when the lead provides a phone number. Use <code className="bg-muted px-1 py-0.5 rounded">{'{phone_number}'}</code> placeholder.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Textarea
              ...
              placeholder={`Great! I will have MJ work this up for you.\n\nIs {phone_number} a good number to reach you?\n\nThanks,\n${clientDisplayName || 'Agent Name'}`}
      ...
      <Card>
        <CardHeader>
          <CardTitle>Template without Phone Number</CardTitle>
          <CardDescription>
      ...
      <Card>
        <CardHeader>
          <CardTitle>CC Email Recipients</CardTitle>
          <CardDescription>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Special Instructions (Internal Notes)</CardTitle>
          <CardDescription>
            Internal notes for team members. Not visible to leads.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Textarea
            ...
            placeholder="e.g., Always CC the sales manager on replies for this client..."
