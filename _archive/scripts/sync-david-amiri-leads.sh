...
echo "============================================"
echo "  Sync David Amiri Leads with Reply UUIDs"
echo "============================================"
echo ""
...
TEMP_FILE="/tmp/david-amiri-reply-uuids-$$.txt"
> "$TEMP_FILE"
...
while IFS='|' read -r REPLY_UUID LEAD_ID; do
  ...
  curl -s -X PATCH "${SUPABASE_URL}/rest/v1/client_leads?workspace_name=eq.David%20Amiri&bison_lead_id=eq.${LEAD_ID}" \
...
echo ""
echo "============================================"
echo -e "${GREEN}Complete! Updated ${UPDATED} David Amiri leads${NC}"
echo "============================================"
echo ""
